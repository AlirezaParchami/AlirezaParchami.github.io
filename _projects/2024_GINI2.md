...
> **TL;DR:** I researched, designed, developed, and deployed the GINI2 application from scratch during my time at AWS-i. GINI2 empowers music teachers to create immersive VR content, helping students learn fundamental drumming techniques and sheet music notation through a highly interactive digital approach.
...
<div class="row justify-content-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        ...
        div class="caption mt-2" style="font-size: 0.85rem;">Filling yellow circles warns about upcoming notes to play</div>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0">
        ...
        div class="caption mt-2" style="font-size: 0.85rem;">Feedback to player according to their timing: correct and on-time (green), correct but off-time (orange), incorrect (red)</div>
    </div>
</div>
