...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "For a full version of my CV and references, feel free to drop me a message with a brief overview of the role you’re looking to fill.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-research-amp-development-at-disney",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=6Pf64OIAAAAJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
